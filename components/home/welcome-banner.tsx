        ...
        <div className="flex items-start gap-4 md:items-center">
          <div>
            <h2 className="text-foreground mb-1 text-lg font-semibold">
              Welcome to Gems of India!
            </h2>
            <p className="text-muted-foreground mb-3 max-w-xl text-sm">
              Discover and rate the best gems of India. Explore daily gems and upvote your favorite
              gems.
            </p>
            <Button onClick={() => router.push("/submit")} variant="outline">
              Submit a Gem
