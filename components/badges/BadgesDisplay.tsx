...
export function BadgesDisplay({ dailyRanking, slug }: BadgesDisplayProps) {
  const lightBadgeCode = `<a href=\"https://gemsofindia.org/${slug}\" target=\"_blank\" title=\"Gems of India Top ${dailyRanking} Daily Winner\">
  <img 
    src=\"https://gemsofindia.org/images/badges/top${dailyRanking}-light.svg\" 
    alt=\"Gems of India Top ${dailyRanking} Daily Winner\" 
    style=\"width: 195px; height: auto;\" 
  />
</a>`

  const darkBadgeCode = `<a href=\"https://gemsofindia.org/${slug}\" target=\"_blank\" title=\"Gems of India Top ${dailyRanking} Daily Winner\">
  <img 
    src=\"https://gemsofindia.org/images/badges/top${dailyRanking}-dark.svg\" 
    alt=\"Gems of India Top ${dailyRanking} Daily Winner\" 
    style=\"width: 195px; height: auto;\" 
  />
</a>`
